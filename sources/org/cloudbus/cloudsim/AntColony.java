...
public class AntColony{
    ...
    protected double Q; // total sum of pheromones
    protected double alpha;
    protected double beta;
    protected double rho;
    protected int m;

    public AntColony(double initialPheromone, double q, double alpha, double beta, double rho, int m) {
    ...
    public AntColony(int m, double initialPheromone, double Q, double alpha, double beta, double rho){
        this.m = m;
        this.initialPheromone = initialPheromone;
        this.Q = Q;
        this.alpha = alpha;
